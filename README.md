...
1. A tidy data set based on the original data set: [tidy_data.txt](https://github.com/prigyan/courseraGetCleanDataInR/blob/master/tidy_data.txt) and [tidy_data.csv](https://github.com/prigyan/courseraGetCleanDataInR/blob/master/tidy_data.csv)
